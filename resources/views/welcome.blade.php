    ...
    <div class="album py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                {{-- <div class="col-md-4">
                    <div class="card mb-4 shadow" style="background-color: #E9E7DA">
                        <img class="border-0 border-dark rounded-top" src="{{ asset('images/phuket-romantic-beaches.jpg') }}" alt="thumbnail" style="object-fit:cover; height: 150px">
                        <div class="card-body">
                        <h5>Header</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-outline-primary">Baca Selengkapnya</button>
                            </div>
                        </div>
                        </div>
                    </div>
